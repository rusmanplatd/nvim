...
Complete Neovim setup with LazyVim configured for TypeScript, React, Next.js, Dart, Flutter, Golang, PHP, Laravel, CSS, SCSS, JSX, HTML, Python3, YAML, XML, Java, Maven, Gradle, Rust, and TOML.
